...
RESUME_SYSTEM = (
    ...
    "32) CRITICAL: The entire resume MUST fit on ONE page when printed on A4 paper. To achieve this: max 2 bullets per job, each bullet max 12 words, skills section as single comma-separated lines only (no bullets), summary max 2 sentences, remove all content not directly matching the job description keywords. Be ruthlessly concise."
